...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(opensearch.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/mathmania/pulumi-%[1]s/sdk/", mainPkg),
	...
	prov.MustComputeTokens(tokens.SingleModule("opensearch_", mainMod,
