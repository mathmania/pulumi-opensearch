...
class IsmPolicyMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, Any]]]] includes: When updating multiple indices, you might want to include a state filter to only affect certain managed indices. The
