...
namespace Pulumi.Opensearch
{
    ...
    public partial class IngestPipeline : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class IngestPipelineArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The JSON body of the ingest pipeline
        /// </summary>
    ...
    public sealed class IngestPipelineState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The JSON body of the ingest pipeline
        /// </summary>
