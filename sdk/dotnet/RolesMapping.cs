...
namespace Pulumi.Opensearch
{
    ...
    public partial class RolesMapping : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class RolesMappingArgs : Pulumi.ResourceArgs
    {
    ...
    public sealed class RolesMappingState : Pulumi.ResourceArgs
    {
        [Input("andBackendRoles")]
        private InputList<string>? _andBackendRoles;
