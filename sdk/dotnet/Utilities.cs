...
namespace Pulumi.Opensearch
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Opensearch.version.txt");
    ...
    internal sealed class OpensearchResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OpensearchResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
